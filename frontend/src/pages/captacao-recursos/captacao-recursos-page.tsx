        ...
        <div className="grid gap-3 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <SecaoCard titulo="Cadastro de doador" descricao="Dados principais, contato, relacionamento e LGPD.">
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={doadorForm.aceitouLgpd} onChange={(event) => setDoadorForm((atual) => ({ ...atual, aceitouLgpd: event.currentTarget.checked }))} />Aceitou LGPD</label>
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={doadorForm.portalAtivo} onChange={(event) => setDoadorForm((atual) => ({ ...atual, portalAtivo: event.currentTarget.checked }))} />Portal doador ativo</label>
            </div>
        ...
        <div className="grid gap-3 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <SecaoCard titulo="Cadastro de campanha" descricao="Meta financeira, identidade visual e mensagem.">
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={campanhaForm.destaqueNoPortal} onChange={(event) => setCampanhaForm((atual) => ({ ...atual, destaqueNoPortal: event.currentTarget.checked }))} />Destaque no portal</label>
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={campanhaForm.visivelAoPublico} onChange={(event) => setCampanhaForm((atual) => ({ ...atual, visivelAoPublico: event.currentTarget.checked }))} />Visível ao público</label>
            </div>
          </SecaoCard>
        </div>
      </div>
        ...
        <div className="grid gap-3 xl:grid-cols-[1.15fr_0.85fr]">
          ...
          <SecaoCard titulo="Cadastro e cobrança" descricao="Doações avulsas e recorrentes.">
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2 md:col-span-2"><Checkbox checked={doacaoForm.recorrenciaAtiva} onChange={(event) => setDoacaoForm((atual) => ({ ...atual, recorrenciaAtiva: event.currentTarget.checked }))} />Ativar doação recorrente</label>
      ...
      <div className="space-y-3">
        <div className="grid gap-3 xl:grid-cols-2">
          <SecaoCard titulo="Geral">
            <div className="grid gap-2">
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={Boolean(configForm.moduloHabilitado)} onChange={(event) => setConfigForm((atual) => ({ ...atual, moduloHabilitado: event.currentTarget.checked }))} />Habilitar módulo</label>
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={Boolean(configForm.portalDoadorHabilitado)} onChange={(event) => setConfigForm((atual) => ({ ...atual, portalDoadorHabilitado: event.currentTarget.checked }))} />Habilitar portal doador</label>
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={Boolean(configForm.campanhasPublicasHabilitadas)} onChange={(event) => setConfigForm((atual) => ({ ...atual, campanhasPublicasHabilitadas: event.currentTarget.checked }))} />Habilitar campanhas públicas</label>
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={Boolean(configForm.doacoesRecorrentesHabilitadas)} onChange={(event) => setConfigForm((atual) => ({ ...atual, doacoesRecorrentesHabilitadas: event.currentTarget.checked }))} />Habilitar doações recorrentes</label>
              <label className="flex items-center gap-2 rounded-md border border-[var(--g3-border)] px-3 py-2"><Checkbox checked={Boolean(configForm.envioAutomaticoComprovantes)} onChange={(event) => setConfigForm((atual) => ({ ...atual, envioAutomaticoComprovantes: event.currentTarget.checked }))} />Envio automático de comprovantes</label>
            </div>
          </SecaoCard>
