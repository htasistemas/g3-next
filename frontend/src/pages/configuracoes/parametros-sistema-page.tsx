...
export function ParametrosSistemaPage() {
  const { settings, applyPreview, clearPreview, saveSettings, carregando } = useTheme();
  ...
  const houveMudanca = useMemo(() => JSON.stringify(draft) !== JSON.stringify(settings), [draft, settings]);
