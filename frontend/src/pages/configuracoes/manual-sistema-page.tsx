    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Use a lista de beneficiários vinculados ao item para marcar quem participará naquela data; a agenda operacional agora usa a própria matrícula da inscrição como referência de seleção e prioriza o telefone principal cadastrado na aba Contato do beneficiário para montar os cards e os envios, mantendo seleção rápida, resumo dos escolhidos e opção de limpar seleção em um clique.",
