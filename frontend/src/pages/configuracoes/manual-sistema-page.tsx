    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "As fotos dos cursos, oficinas e atendimentos são enviadas para o storage autenticado do sistema; o cadastro grava apenas o caminho do arquivo e exibe a imagem na prévia e nos cards do catálogo.",
    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Ao cadastrar um bem, informe número do patrimônio, nome, categoria, conservação, status, origem, responsável, unidade e demais dados de identificação. Novo cadastro sugere a unidade principal e permite selecionar qualquer unidade cadastrada.",
