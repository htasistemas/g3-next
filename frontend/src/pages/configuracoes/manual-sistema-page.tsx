    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Use a lista de beneficiários vinculados ao item para marcar quem participará naquela data; a agenda operacional agora usa a própria matrícula da inscrição como referência de seleção, cruza os participantes com o cadastro real do beneficiário dentro da instituição para reaproveitar telefone e e-mail atualizados, e mantém seleção rápida, resumo dos escolhidos e opção de limpar seleção em um clique.",
