    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Use a lista de beneficiários vinculados ao item para marcar quem participará naquela data; a agenda operacional agora usa a própria matrícula da inscrição e também os identificadores legados salvos no card para localizar o cadastro do beneficiário, exibindo no card o telefone principal da aba Contato e reaproveitando o mesmo dado nos envios.",
