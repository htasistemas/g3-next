    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Informe a data do agendamento e use Gerar Agenda para salvar a agenda do dia com os participantes agrupados no mesmo card. Não há um segundo botão de salvar: o clique em Gerar Agenda já persiste o card imediatamente. Cada combinação diferente de item e tipo mantém seu próprio card na mesma data; ao gerar novamente o mesmo item e tipo para a mesma data, o card correspondente é atualizado sem substituir os demais.",
          ...
          "Agendas legadas que tenham sido gravadas sem os identificadores operacionais são recuperadas pela combinação de data, item, profissional e sala, para que continuem visíveis e editáveis como cards.",
