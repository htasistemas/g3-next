    ...
    telas: [
      {
        ...
        comoUsar: [
          ...
          "O card Documentos vencidos permanece com a cor padrão da unidade e destaca a borda em vermelho piscando quando houver um ou mais documentos com validade expirada.",
    ...
    telas: [
      {
        ...
        comoUsar: [
          ...
          "Na aba Listagem de beneficiários, os campos de código e CPF exibidos como exemplo não filtram a consulta inicial; mesmo se o navegador reenviar código 0001, CPF zerado ou status Todos, a API ignora esses placeholders. Quando uma base legada ainda tiver beneficiários sem tenant gravado, a listagem usa fallback de recuperação para voltar a exibir os cadastros enquanto a compatibilização é aplicada.",
    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "No cadastro de um atendimento, escolha Controlar por horário para criar vagas individuais a partir do início, fim e duração (por exemplo, 19:00, 19:30, 20:00 e 20:30), ou Controlar por período para informar uma quantidade total de vagas.",
          ...
          "Na aba Inscrições, o botão Editar horário permite corrigir a data e o horário de um beneficiário já incluído. Em atendimentos controlados por horário, somente vagas livres são exibidas; a mesma data e horário não podem ser usados novamente, inclusive em tentativas simultâneas.",
    ...
    telas: [
      {
        ...
        comoUsar: [
          ...
          "Use o bloco Operação alimentar para acompanhar cestas entregues, cestas a entregar, cestas atrasadas e ranking de bairros atendidos no período.",
          "Use Frequência dos cursos para monitorar aulas registradas, presenças, ausências, justificativas, taxa de ausência e cursos com maior necessidade de busca ativa.",
          "Use Idade por bairro para cruzar território e ciclo de vida, identificando bairros com concentração de crianças, adolescentes, jovens, adultos, idosos ou cadastros sem data de nascimento.",
          "Use IA territorial para priorizar bairros por criticidade calculada com beneficiários ativos, cestas pendentes e ausências em cursos.",
        ...
        atencoes: [
          ...
          "As métricas de cesta usam doações realizadas e planejadas com descrição ou tipo contendo CESTA; mantenha o cadastro de itens padronizado para melhorar a precisão dos painéis.",
          "A taxa de ausência dos cursos depende dos lançamentos em cursos_atendimentos_presencas; aulas sem frequência lançada não entram como presença nem ausência.",
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Os cards Beneficiários ativos, Cadastro completo, Renda média familiar e Termos ativos agora usam gráficos modernos variados (pizza, rosca, colunas e linha), com tooltip para detalhar os valores e sombra para destacar cada widget.",
    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Passe o mouse sobre o label de qualquer campo para consultar uma sugestão curta sobre o tipo de informação esperado. Use a orientação como guia e preencha os dados oficiais da instituição.",
          ...
          "Na aba Listagem, a ordenação padrão considera a data do Período inicial: os planos com início mais recente aparecem primeiro. Use a opção Período inicial mais antigo para inverter a ordem.",
          "A listagem do plano de trabalho mostra o valor total do plano de aplicação e a indicação política do termo vinculado quando houver responsável informado, sem exibir a coluna de nome da instituição.",
    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Use Contas bancárias para cadastrar contas e depois acompanhar cada conta em cards com banco, agência, número, saldo atual, Pix, projeto vinculado, fonte de pagamento e status.",
          "Na aba Contas bancárias, preencha Fonte de pagamento quando a conta precisar alimentar as opções de fonte da aba Receitas na Prestação de contas.",
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Na Visão geral, os campos Total recebido, Total aplicado, Saldo disponível e Prestado no mês usam máscara de moeda brasileira; o Saldo disponível é calculado automaticamente por Total recebido menos Total aplicado.",
          "No card Despesas e pagamentos, os campos Descrição e Fornecedor têm mais espaço para digitação e o campo Valor usa máscara de moeda brasileira.",
          ...
          "Na aba Receitas, selecione a Fonte a partir das fontes de pagamento vinculadas às contas bancárias da contabilidade, informe Valor com máscara de moeda e escolha Periodicidade e Situação nas opções disponíveis.",
          ...
          "Na aba Aplicação dos recursos, o campo Percentual usa máscara de porcentagem e ocupa menos espaço para ampliar o campo Descrição.",
          ...
          "Use Gerar relatório para emitir o relatório completo da prestação de contas. Com um registro selecionado, o sistema gera o relatório detalhado daquele processo; sem seleção, gera um relatório consolidado da listagem filtrada.",
          "O relatório de prestação de contas apresenta resumo executivo, identificação do instrumento, período, objeto, totais financeiros, receitas, aplicação dos recursos, despesas, comprovantes, timeline, checklist, pendências, parecer técnico, histórico de pareceres e campos de assinatura.",
    ...
    telas: [
      {
        ...
        comoUsar: [
          ...
          "A Central de pendências da Visão geral consolida alertas reais de documentação acadêmica ausente, aulas sem chamada, baixa frequência, turmas sem professor responsável e turmas próximas da capacidade máxima. Clique em cada linha para abrir o contexto operacional relacionado.",
          "Ao abrir uma pendência educacional, a tela lista os registros que geraram o alerta e mantém o atalho Abrir fluxo para a correção operacional correspondente, sem misturar dados entre instituições.",
          "Pendências de documentos abrem o formulário de Documentos/Declarações com aluno e matrícula preenchidos. Pendências de chamada abrem Frequência e chamada com a aula selecionada para lançamento imediato. Pendências de baixa frequência abrem a Vida acadêmica 360º do aluno e pendências de turma abrem Estrutura acadêmica com a turma em edição.",
          ...
          "Na aba Alunos, o campo de busca por nome filtra diretamente os alunos agrupados; CPF e telefone são consultados somente quando o termo informado possui números.",
          ...
          , "Use Diário de classe para registrar conteúdo por turma, componente e data. Em Chamada/Frequência, selecione a aula registrada, carregue todos os alunos ativos da turma, marque todos como presentes quando aplicável e altere somente as exceções; os registros permanecem salvos no histórico.",
          ...
          , "Use Boletins para gerar automaticamente média, frequência e resultado por período da matrícula a partir das notas e chamadas já lançadas. Use Histórico escolar para gerar automaticamente o registro anual do aluno a partir da matrícula, boletins, frequência e resultado final. Ajustes manuais continuam disponíveis quando houver necessidade administrativa."
          ...
          , "Em Recuperações, informe ano letivo, período, disciplina e média mínima para o sistema sugerir alunos com notas abaixo do esperado. A sugestão não decide o resultado do aluno; ela apenas abre a recuperação para revisão e lançamento humano."
          , "Em Configurações educacionais, mantenha parâmetros por instituição, como média mínima, frequência mínima, períodos avaliativos e capacidade padrão. Essas configurações ficam isoladas por tenant."
          , "Em Gestão acadêmica, use Rematrículas para criar uma nova matrícula para o próximo ano letivo sem alterar ou sobrescrever a matrícula anterior. A movimentação fica registrada no histórico acadêmico do aluno."
          , "Em Rematrículas, selecione uma matrícula no campo individual ou marque várias matrículas na lista para rematricular em lote. O sistema cria novos vínculos para o ano letivo informado, preserva o histórico anterior e retorna quantas rematrículas foram criadas ou recusadas por validação."
          , "O menu Gestão educacional foi organizado em entradas principais: Visão geral; Alunos; Vida acadêmica 360º; Vida escolar; Estrutura acadêmica; Professores e equipe pedagógica; Gestão escolar; Parcerias públicas; e Relatórios e indicadores. As operações relacionadas ficam nas abas internas de cada contexto."
          ...
          , "Na aba Matrículas, o botão Criar matrícula grava o vínculo com um clique após aluno, unidade de ensino, sala, ano letivo, etapa, série e número da matrícula estarem preenchidos; as mensagens retornadas pela API são exibidas de forma amigável na própria tela."
          , "No Diário de classe, salve a aula com conteúdo, objetivos, atividades e observações. Após salvar, o sistema abre a chamada da turma na mesma tela para lançamento imediato de frequência."
          , "Em Documentos e declarações, selecione uma matrícula e use Gerar declaração de matrícula para abrir o documento preenchido automaticamente e salvar como PDF pelo navegador, sem armazenar binário no banco."
          , "Em Desenvolvimento infantil, registre parecer descritivo qualitativo usando o modelo de parecer como apoio. O registro não usa nota numérica e deve descrever fatos observados no desenvolvimento da criança."
          , "O campo Número da matrícula é preenchido automaticamente com o próximo sequencial disponível, iniciando em 00001, mas permanece editável. Ao salvar, o backend confere se o número informado já existe na instituição e bloqueia a duplicidade."
          , "A matrícula completa permite registrar origem, escola anterior, responsável pela matrícula, transporte escolar, conferência de documentação e informações complementares sem duplicar cadastros de pessoas."
          , "A tela Vida acadêmica 360º pode ser aberta diretamente pelo menu Gestão educacional ou pela subaba do grupo Alunos. Pesquise o aluno e use o botão Vida acadêmica para abrir uma visão consolidada com identificação, matrículas, frequência geral, notas, ocorrências, documentos, histórico e linha do tempo acadêmica, sempre respeitando o tenant autenticado."
          , "A Vida acadêmica 360º também exibe endereço, contatos, responsáveis familiares, documentos do cadastro central e alertas acadêmicos calculados a partir de frequência, matrícula, documentos e dados cadastrais."
          , "A matrícula também valida a compatibilidade da turma selecionada com ano letivo, unidade de ensino, sala, etapa e série, impedindo vínculos acadêmicos incoerentes."
      ...
      {
        nome: "Passo a passo da vida acadêmica do aluno",
        objetivo: "Orientar a secretaria, coordenação e equipe pedagógica no uso do menu Gestão educacional desde a preparação da matrícula até o encerramento da vida escolar do aluno.",
        comoUsar: [
          "Comece pela preparação da escola. Acesse Cadastros principais > Unidades de atendimento, abra a unidade de ensino e confira se o tipo da unidade está como Unidade de ensino. Na aba Salas de atendimento, cadastre as salas, informe as vagas de cada sala e salve a unidade.",
          "Depois acesse Gestão educacional > Estrutura acadêmica. Cadastre ou confira o Ano letivo, as Etapas de ensino, as Séries ou anos escolares e os Componentes curriculares. Esses cadastros formam a base para matrícula, turma, diário, notas, boletim e histórico.",
          "Ainda em Estrutura acadêmica, cadastre a Turma. Selecione ano letivo, unidade de ensino, etapa, série, turno, sala e capacidade máxima. A turma deve ser compatível com a sala e com a etapa/série que serão usadas na matrícula.",
          "Se houver equipe pedagógica definida, acesse Professores e equipe pedagógica. Vincule o profissional já cadastrado no sistema à função educacional, unidade, turma ou componente curricular. Não crie outro cadastro da mesma pessoa se ela já existir como profissional.",
          "Antes de matricular, confirme se a criança, adolescente ou jovem já existe no Cadastro de beneficiários. O G3N usa cadastro único de pessoas; por isso, o aluno deve nascer do beneficiário existente sempre que aplicável.",
          "Acesse Gestão educacional > Alunos > Matrículas. Pesquise o beneficiário por nome, CPF ou código. Quando encontrar o cadastro correto, selecione o registro e clique em Vincular aluno selecionado.",
          "Na mesma aba Matrículas, preencha Nova matrícula. Selecione aluno, unidade de ensino, sala disponível, ano letivo, etapa, série, turma quando houver, origem, escola anterior quando aplicável, responsável pela matrícula, transporte escolar e documentação conferida.",
          "O campo Número da matrícula já vem preenchido com o próximo número sequencial, começando em 00001. O usuário pode editar esse número antes de salvar. Ao clicar em Criar matrícula, o sistema confere se o número já existe e bloqueia duplicidade.",
          "Se o sistema informar que a capacidade da sala precisa ser configurada, volte em Unidades de atendimento > Salas de atendimento, informe as vagas da sala e salve a unidade. Depois retorne à matrícula.",
          "Após criar a matrícula, acesse Alunos > Alunos por turma para conferir se o aluno aparece na unidade, sala, turma e situação corretas. Use os filtros de unidade, ano letivo, sala, situação ou busca por nome para localizar rapidamente.",
          "Para revisar tudo que já foi registrado do aluno, acesse Vida acadêmica 360º pelo menu principal ou pelo botão Vida acadêmica na listagem de alunos. Essa tela consolida identificação, matrícula atual, histórico de matrículas, contatos, responsáveis, documentos, frequência, notas, ocorrências, histórico escolar e linha do tempo.",
          "Com a turma criada, acesse Diário de classe. Registre a aula informando turma, componente curricular, data, conteúdo ministrado, objetivos, atividades e observações. Após salvar a aula, o sistema abre a chamada da turma na mesma tela.",
          "Na chamada, use Marcar todos presentes quando a maioria dos alunos esteve presente. Depois altere apenas as exceções para ausência, falta justificada, atraso ou saída antecipada. Salve a chamada para alimentar frequência, boletim, histórico e indicadores.",
          "Quando houver atividade avaliativa, acesse Avaliações e notas > Avaliações. Cadastre a avaliação informando turma, componente curricular, período, tipo, data, valor máximo e peso.",
          "Depois acesse Avaliações e notas > Notas. Selecione a avaliação e a matrícula do aluno, informe a nota ou conceito e salve. O backend valida a nota contra o valor máximo da avaliação.",
          "Quando houver aluno abaixo da média, acesse Gestão escolar > Recuperações. Informe ano letivo, período, componente curricular e média mínima para consultar sugestões. O sistema apenas aponta possíveis alunos para recuperação; a decisão e o lançamento continuam sendo humanos.",
          "Para ocorrências pedagógicas ou administrativas, acesse Gestão escolar > Ocorrências. Registre aluno, matrícula quando aplicável, data, tipo, descrição, providências, comunicação ao responsável e status. Esse registro passa a compor a Vida acadêmica 360º.",
          "Na seleção e na listagem de ocorrências, o aluno é apresentado pelo nome completo; código e matrícula ficam disponíveis apenas como referências complementares quando retornados pela consulta.",
          "Para eventos escolares, reuniões, atividades coletivas ou compromissos da turma, acesse Gestão escolar > Agenda escolar. Registre unidade, turma ou aluno, data inicial, data final quando houver, tipo, título e descrição.",
          "Para documentos do aluno, acesse Documentos acadêmicos > Documentos e declarações. Selecione aluno ou matrícula, informe tipo, título e data de emissão. Para declaração de matrícula, selecione a matrícula e clique em Gerar declaração de matrícula para abrir o documento preenchido.",
          "Para boletim, acesse Documentos acadêmicos > Boletins. Selecione matrícula, ano letivo e período. Clique para gerar automaticamente; o sistema calcula média, frequência e resultado usando notas, avaliações e chamadas já registradas.",
          "Para histórico escolar, acesse Documentos acadêmicos > Histórico escolar. Selecione aluno e ano letivo. O sistema busca matrícula, unidade, etapa, série, boletins, frequência e resultado final para montar o registro anual.",
          "Ao final de um período avaliativo, revise pendências na Visão geral. Verifique chamadas pendentes, documentos ausentes, baixa frequência, turmas sem professor e turmas próximas da capacidade máxima. Clique na pendência para abrir o fluxo já direcionado.",
          "Ao final do ano letivo, lance ou confira o Resultado final em Gestão escolar. Registre aprovado, reprovado, transferido, abandono ou outra situação prevista pela instituição, sempre mantendo observação quando necessário.",
          "Para rematrícula, acesse Gestão escolar > Rematrículas. Selecione a matrícula atual, informe novo ano letivo, unidade, sala, etapa, série, turma e data de início. O sistema cria uma nova matrícula e preserva a matrícula anterior no histórico.",
          "Para rematrícula em lote, marque várias matrículas na lista e preencha os dados do novo vínculo. O sistema informa quantas rematrículas foram criadas e quais foram recusadas por validação.",
          "Para transferência, use Vida escolar > Transferências ou a ação de transferência da matrícula quando disponível. Informe destino, sala, turma quando for transferência interna, data, motivo e observações. O sistema encerra o vínculo anterior sem apagar o histórico.",
          "Durante toda a vida escolar, use Vida acadêmica 360º como ponto de conferência. Sempre que houver dúvida, abra o aluno nessa tela para validar matrícula, frequência, desempenho, documentos, ocorrências, histórico e movimentações.",
          "Quando o aluno concluir, for transferido definitivamente ou encerrar o vínculo com a instituição, gere os documentos finais necessários e mantenha a situação acadêmica atualizada. Não exclua registros históricos de matrícula, frequência, notas, boletins ou histórico escolar."
        ],
        atencoes: [
          "Não matricule aluno diretamente em uma turma sem antes conferir unidade de ensino, sala, ano letivo, etapa e série.",
          "Não crie cadastro duplicado de pessoa. Use o beneficiário existente e vincule-o como aluno.",
          "Não altere matrícula antiga para representar ano novo. Use Rematrículas para criar novo vínculo e preservar o histórico anterior.",
