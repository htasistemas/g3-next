    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Use a lista de beneficiários vinculados ao item para marcar quem participará naquela data; a agenda operacional agora usa a própria matrícula da inscrição como referência de seleção, cruza os participantes com o cadastro real do beneficiário dentro da instituição para reaproveitar telefone e e-mail atualizados e aceita telefone principal, secundário ou de recado quando houver, mantendo seleção rápida, resumo dos escolhidos e opção de limpar seleção em um clique.",
          ...
          "Os ícones de WhatsApp e e-mail dos cards da aba Agendamento agora recarregam os contatos atuais do beneficiário antes do envio, tratam contatos inválidos individualmente e continuam processando os demais destinatários sem derrubar a ação com erro interno do servidor.",
