    ...
    telas: [
      ...
      },
      {
        ...
        comoUsar: [
          ...
          "Para atendimentos individuais, selecione Atendimento por horário marcado. Informe o período e a duração; o sistema cria os horários disponíveis no banco e permite vincular um beneficiário oficial a cada horário, sem ultrapassar o término da agenda.",
          "Os horários individuais aparecem na agenda principal como Livres ou Agendados. Cancelar um atendimento libera somente aquele horário e mantém o histórico; uma agenda coletiva continua usando a lista de participantes existente.",
