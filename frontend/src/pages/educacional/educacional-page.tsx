...
type Aba = "visao-geral" | "estrutura" | "alunos" | "matriculas" | "responsaveis" | "unidades" | "enturmacao" | "professores" | "grade-curricular" | "horarios" | "diarios" | "frequencias" | "planos-aula" | "planejamentos" | "avaliacoes" | "notas" | "boletins" | "historicos" | "ocorrencias" | "agenda" | "documentos" | "relatorios" | "rotinas-infantis" | "desenvolvimentos-infantis" | "transferencias" | "autorizacoes" | "fluxo-academico" | "parcerias";
...
export function EducacionalPage() {
  ...
  const abasGrupo: Array<{ label: string; aba: Aba; secao: string }> = grupo === "alunos"
    ? [{ secao: "Cadastro e matrícula", label: "Alunos", aba: "alunos" }, { secao: "Cadastro e matrícula", label: "Matrículas", aba: "matriculas" }, { secao: "Cadastro e matrícula", label: "Alunos por turma", aba: "enturmacao" }, { secao: "Cadastro e matrícula", label: "Responsáveis e famílias", aba: "responsaveis" }]
    : grupo === "vida-escolar"
