...
export function BibliotecaPage() {
  ...
  return (
    <>
      <AdminPageLayout tabs={abas} activeTab={abaAtiva} onChangeTab={(tabId) => setAbaAtiva(tabId as AbaId)} actions={acoes} sectionLabel="Atendimentos diários" pageTitle={tituloTela} activeTitle={abas.find((item) => item.id === abaAtiva)?.label} codeBadge={livroSelecionadoId ?? emprestimoSelecionadoId ? `Código: ${livroSelecionadoId ?? emprestimoSelecionadoId}` : "Novo"}>
