...
export function useChamadosTecnicos(filtros: ChamadoTecnicoFiltros) {
  return useQuery({
    queryKey: ["chamados-tecnicos", filtros],
...
export function useChamadoTecnico(id?: string) {
  return useQuery({
    queryKey: ["chamados-tecnicos", "detalhe", id],
...
export function useChamadosTecnicosCatalogo() {
  return useQuery({
    queryKey: ["chamados-tecnicos", "catalogo"],
...
export function useChamadosTecnicosFiltrosSalvos() {
  return useQuery({
    queryKey: ["chamados-tecnicos", "filtros-salvos"],
...
export function useSalvarFiltroChamadoTecnico() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: ["chamados-tecnicos", "filtros-salvos"] });
    }
  });
}
...
export function useSalvarParametroChamadoTecnico() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: ["chamados-tecnicos", "catalogo"] });
    }
  });
}
