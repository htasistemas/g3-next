...
const routeModules: RouteModuleDefinition[] = [
  ...
  { path: "/cadastros/pessoas", loader: () => import("@/pages/cadastros/pessoas-page") },
  {
  ...
  },
  {
    ...
    loader: () => import("@/pages/atendimentos/historico-geral-page")
  },
  {
  ...
  },
  {
    ...
    loader: () => import("@/pages/configuracoes/sobre-o-sistema-page")
  }
];
