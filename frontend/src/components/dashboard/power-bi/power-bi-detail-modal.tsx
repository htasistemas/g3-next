      ...
      >
        <div className="flex flex-col gap-3 border-b border-[var(--g3-border)] px-5 py-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-1">
            <h3 className="text-lg font-semibold text-[var(--g3-foreground)]">
              {tabela?.titulo ?? "Detalhamento"}
            </h3>
        ...
        <div className="flex flex-col gap-4 px-5 py-4">
          {carregando ? (
            <div className="flex min-h-[260px] flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-[var(--g3-border)] bg-[var(--g3-card-soft)]/50 px-4 text-center">
              <RefreshCw className="h-5 w-5 animate-spin text-[var(--g3-active)]" />
              <p className="text-sm font-medium text-[var(--g3-foreground)]">Carregando detalhamento</p>
              <p className="text-sm text-[var(--g3-muted)]">
                Os dados detalhados estão sendo buscados sob demanda.
              </p>
            </div>
          ) : erro ? (
            <div className="flex min-h-[260px] flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-rose-200 bg-rose-50/80 px-4 text-center">
            ...
            <div className="flex min-h-[260px] items-center justify-center rounded-2xl border border-dashed border-[var(--g3-border)] bg-[var(--g3-card-soft)]/40 px-4 text-center text-sm text-[var(--g3-muted)]">
