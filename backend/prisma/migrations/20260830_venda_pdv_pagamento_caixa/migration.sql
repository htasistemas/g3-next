-- A tabela-base venda_setor pode existir somente em instalações que já ativaram o PDV.
-- O módulo de vendas também garante estas estruturas quando for utilizado.
DO $$
BEGIN
  IF to_regclass('public.venda_setor') IS NULL THEN
    RETURN;
  END IF;
