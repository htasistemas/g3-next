...
const envSchema = z
    ...
    const backupCredenciaisEspecificas = !!env.APP_BACKUP_IMAGES_GOOGLE_CLIENT_ID &&
        !!env.APP_BACKUP_IMAGES_GOOGLE_CLIENT_SECRET &&
        !!env.APP_BACKUP_IMAGES_REFRESH_TOKEN;
    const backupCredenciaisGenericas = !!env.APP_GOOGLE_CLIENT_ID &&
    ...
    if (env.APP_BACKUP_IMAGES_HABILITADO &&
        ...
        ctx.addIssue({
            ...
            message: "APP_BACKUP_IMAGES_GOOGLE_DRIVE_FOLDER_ID e as credenciais OAuth do backup sao obrigatorios quando o backup de imagens estiver habilitado"
        });
    }
