...
captacaoRecursosRoutes.put("/campanhas/:id", ensureAuthenticated, ensurePermissions(permissaoCampanhasEdit), asyncHandler(controller.salvarCampanha.bind(controller)));
captacaoRecursosRoutes.patch("/campanhas/:id/status", ensureAuthenticated, ensurePermissions(permissaoCampanhasPausar), asyncHandler(controller.alterarStatusCampanha.bind(controller)));
captacaoRecursosRoutes.get("/doacoes", ensureAuthenticated, ensurePermissions(permissaoDoacoesView), asyncHandler(controller.listarDoacoes.bind(controller)));
captacaoRecursosRoutes.post("/doacoes", ensureAuthenticated, ensurePermissions(permissaoDoacoesEdit), asyncHandler(controller.salvarDoacao.bind(controller)));
captacaoRecursosRoutes.get("/doacoes/:id", ensureAuthenticated, ensurePermissions(permissaoDoacoesView), asyncHandler(controller.buscarDoacao.bind(controller)));
captacaoRecursosRoutes.put("/doacoes/:id", ensureAuthenticated, ensurePermissions(permissaoDoacoesEdit), asyncHandler(controller.salvarDoacao.bind(controller)));
captacaoRecursosRoutes.post("/doacoes/:id/gerar-cobranca", ensureAuthenticated, ensurePermissions(permissaoCobranca), asyncHandler(controller.gerarCobranca.bind(controller)));
captacaoRecursosRoutes.post("/doacoes/:id/confirmar", ensureAuthenticated, ensurePermissions(permissaoConfirmar), asyncHandler(controller.confirmarDoacao.bind(controller)));
captacaoRecursosRoutes.post("/doacoes/:id/cancelar", ensureAuthenticated, ensurePermissions(permissaoCancelar), asyncHandler(controller.cancelarDoacao.bind(controller)));
captacaoRecursosRoutes.post("/doacoes/:id/estornar", ensureAuthenticated, ensurePermissions(permissaoEstornar), asyncHandler(controller.estornarDoacao.bind(controller)));
captacaoRecursosRoutes.post("/doacoes/:id/emitir-comprovante", ensureAuthenticated, ensurePermissions(permissaoComprovantes), asyncHandler(controller.emitirComprovante.bind(controller)));
captacaoRecursosRoutes.post("/doacoes/:id/reenviar-comprovante", ensureAuthenticated, ensurePermissions(["ADMINISTRADOR", "CAPTACAO_COMPROVANTES_REENVIAR"]), asyncHandler(controller.reenviarComprovante.bind(controller)));
captacaoRecursosRoutes.get("/comprovantes", ensureAuthenticated, ensurePermissions(permissaoDoacoesView), asyncHandler(controller.listarComprovantes.bind(controller)));
captacaoRecursosRoutes.get("/configuracoes", ensureAuthenticated, ensurePermissions(permissaoConfig), asyncHandler(controller.configuracoes.bind(controller)));
...
captacaoRecursosRoutes.post("/portal/recorrencias/:id/cancelar", asyncHandler(controller.portalCancelarRecorrencia.bind(controller)));
