import { z } from "zod";
import { normalizarCnpj, normalizarCpf, normalizarEmail, normalizarTelefone, validarCnpj, validarCpf, validarEmail } from "../../utils/br-utils.js";
import { captacaoCategoriaDoadorValues, captacaoFormaPagamentoValues, captacaoOrigemDoacaoValues, captacaoPeriodicidadeValues, captacaoSituacaoDoacaoValues, captacaoStatusCampanhaValues, captacaoStatusDoadorValues, captacaoStatusRecorrenciaValues, captacaoTipoCampanhaValues, captacaoTipoDoacaoValues, captacaoTipoDoadorValues } from "./captacao-recursos.types.js";
...
export const captacaoDoadorInputSchema = z
    ...
    if (["pessoa_juridica", "patrocinador", "parceiro"].includes(input.tipoDoador) &&
        documento &&
        documento.length === 14 &&
