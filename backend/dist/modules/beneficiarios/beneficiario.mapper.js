...
export function mapBeneficiarioToResponse(record) {
    ...
    return {
        ...
        permite_contato_whatsapp: undefined,
        permite_contato_sms: contato?.permiteContatoSms ?? undefined,
        permite_contato_email: undefined,
