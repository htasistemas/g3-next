...
import { montarMensagemAlteracoesBeneficiario, montarResumoAlteracoesBeneficiario, obterDestinatariosAlteracaoBeneficiario } from "../services/beneficiario-email-notificacao.js";
...
test("obterDestinatariosAlteracaoBeneficiario deduplica os emails antigo e atual", () => {
    const destinatarios = obterDestinatariosAlteracaoBeneficiario({ email: "dudalopesfreitasbr@gmail.com" }, { email: "DUDALOPESFREITASBR@gmail.com " });
