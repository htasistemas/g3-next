...
authRoutes.post("/passkeys/register/options", ensureAuthenticated, asyncHandler(controller.iniciarCadastroPasskey.bind(controller)));
authRoutes.post("/passkeys/register/verify", ensureAuthenticated, asyncHandler(controller.concluirCadastroPasskey.bind(controller)));
...
authRoutes.get("/me/preferencias/agendamentos", ensureAuthenticated, asyncHandler(controller.obterPreferenciaAgendamentos.bind(controller)));
authRoutes.put("/me/preferencias/agendamentos", ensureAuthenticated, asyncHandler(controller.salvarPreferenciaAgendamentos.bind(controller)));
