...
export function existeNovaVersao(versaoInstalada, versaoPublicada) {
    return compararVersoes(versaoPublicada, versaoInstalada) > 0;
}
export async function calcularSha256Arquivo(caminhoArquivo) {
...
export function formatarDuracaoHumana(duracaoMs) {
