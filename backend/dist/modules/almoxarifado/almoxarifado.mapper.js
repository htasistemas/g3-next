...
export function mapAlmoxarifadoItemToResponse(row) {
    return {
        ...
        estoque_fisico: row.estoque_fisico ?? row.estoque_atual,
        estoque_disponivel: row.estoque_disponivel ?? row.estoque_atual,
        estoque_montavel_kit: row.estoque_montavel_kit ?? undefined,
        estoque_minimo: row.estoque_minimo,
        valor_unitario: row.valor_unitario,
        is_kit: row.is_kit,
        possui_composicao_kit: row.possui_composicao_kit ?? false,
...
export function mapAlmoxarifadoMovimentacaoToResponse(row) {
    return {
...
export function mapAlmoxarifadoKitComposicaoToResponse(row) {
    return {
        id: Number(row.id),
