...
export function formatarDataAlertaEmailDocumento(valor) {
    if (!valor)
        return "---";
...
export function formatarSituacaoAlertaEmailDocumento(situacao) {
    switch (situacao) {
        case "vencido":
            return "Vencido";
        case "vence_em_breve":
...
export function deveEnviarAlertaEmailDocumento(documento) {
    if (documento.gerarAlerta === false)
        return false;
    return documento.situacao === "vencido" || documento.situacao === "vence_em_breve";
}
export function montarObservacaoHistoricoAlertaEmailDocumento(documento, referenciaIso = criarReferenciaAlertaEmailDocumento()) {
...
export function montarMensagemAlertaEmailDocumentos(nomeUnidade, documentos, referenciaIso = criarReferenciaAlertaEmailDocumento()) {
