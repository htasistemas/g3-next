...
export class RhContratacaoController {
    ...
    async atualizarCandidato(request, response) {
        const candidato = await service.atualizarCandidato(request.params.id, request.body, this.obterUsuarioId(request));
        return response.json(candidato);
    }
    ...
    async atualizarStatus(request, response) {
        const processo = await service.atualizarStatus(request.params.processoId, request.body, this.obterUsuarioId(request));
        return response.json(processo);
    }
    ...
    async salvarEntrevista(request, response) {
        const entrevista = await service.salvarEntrevista(request.params.processoId, request.body, this.obterUsuarioId(request));
    ...
    async salvarFicha(request, response) {
        const ficha = await service.salvarFicha(request.params.processoId, request.body, this.obterUsuarioId(request));
        return response.json(ficha);
    }
    ...
    async atualizarDocumento(request, response) {
        const documento = await service.atualizarDocumento(request.params.documentoId, request.body, this.obterUsuarioId(request));
    ...
    async adicionarArquivo(request, response) {
        const arquivo = await service.adicionarArquivo(request.params.processoId, request.body, this.obterUsuarioId(request));
    ...
    async salvarTermo(request, response) {
        const termo = await service.salvarTermo(request.params.processoId, request.body, this.obterUsuarioId(request));
    ...
    async salvarPpd(request, response) {
        const ppd = await service.salvarPpd(request.params.processoId, request.body, this.obterUsuarioId(request));
        return response.json(ppd);
    }
    ...
    async salvarCartaBanco(request, response) {
        const carta = await service.salvarCartaBanco(request.params.processoId, request.body, this.obterUsuarioId(request));
        return response.json(carta);
    }
