...
const permissaoVisualizacaoPorRecurso = {
...
const visualizarPorRecurso = (request, response, next) => {
...
const editarPorRecurso = (request, response, next) => {
