...
export class ReportsService {
    ...
    registroPontoService = new RegistroPontoService();
    ...
    blocoComCampos(titulo, colunas, campos, destaque = false) {
        const camposPreenchidos = campos.filter((campo) => !!campo);
    ...
    montarBlocosFichaBeneficiario(beneficiario) {
        ...
        const telefoneRecado = [
            ...
            .join(" - ");
        return [
            this.blocoComCampos("Identificação do beneficiário", 2, [
        ...
        const relatorioInput = {
            ...
            blocos: [
                ...
                },
                {
                    ...
                    colunas: 1,
                    campos: [
                        this.campo("Tratamento de dados pessoais", payload.finalidadeDados || "Conforme autorização institucional."),
    ...
    formatarMinutosRelatorio(totalMinutos) {
