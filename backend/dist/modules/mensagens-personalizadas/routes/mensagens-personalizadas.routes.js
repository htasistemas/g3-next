...
mensagensPersonalizadasRoutes.get("/suporte", ensureAuthenticated, ensurePermissions(permissoesVisualizacao), asyncHandler(controller.obterSuporte.bind(controller)));
mensagensPersonalizadasRoutes.get("/modelos", ensureAuthenticated, ensurePermissions(permissoesVisualizacao), asyncHandler(controller.listarModelos.bind(controller)));
mensagensPersonalizadasRoutes.get("/modelos/:id", ensureAuthenticated, ensurePermissions(permissoesVisualizacao), asyncHandler(controller.obterModelo.bind(controller)));
mensagensPersonalizadasRoutes.post("/modelos", ensureAuthenticated, ensurePermissions(permissoesCadastro), asyncHandler(controller.criarModelo.bind(controller)));
mensagensPersonalizadasRoutes.put("/modelos/:id", ensureAuthenticated, ensurePermissions(permissoesCadastro), asyncHandler(controller.atualizarModelo.bind(controller)));
mensagensPersonalizadasRoutes.post("/modelos/:id/duplicar", ensureAuthenticated, ensurePermissions(permissoesCadastro), asyncHandler(controller.duplicarModelo.bind(controller)));
mensagensPersonalizadasRoutes.patch("/modelos/:id/status", ensureAuthenticated, ensurePermissions(permissoesCadastro), asyncHandler(controller.atualizarStatusModelo.bind(controller)));
mensagensPersonalizadasRoutes.delete("/modelos/:id", ensureAuthenticated, ensurePermissions(permissoesExclusao), asyncHandler(controller.excluirModelo.bind(controller)));
mensagensPersonalizadasRoutes.get("/taxonomias", ensureAuthenticated, ensurePermissions(permissoesVisualizacao), asyncHandler(controller.listarTaxonomias.bind(controller)));
mensagensPersonalizadasRoutes.post("/taxonomias", ensureAuthenticated, ensurePermissions(permissoesCadastro), asyncHandler(controller.criarTaxonomia.bind(controller)));
