...
export class BibliotecaService {
    ...
    async registrarDevolucao(rawId, rawInput) {
        const id = this.parseId(rawId);
        const input = typeof rawInput === "object" && rawInput && "dataDevolucaoReal" in rawInput
