...
export const mapaCamposTextoBeneficiario: Record<string, TipoFormatacaoTexto> = {
...
export const mapaDocumentoBeneficiario: Record<string, TipoFormatacaoTexto> = {
  nome: "textoCurto"
};

export const mapaCamposTextoFamilia: Record<string, TipoFormatacaoTexto> = {
...
export const mapaMembroFamilia: Record<string, TipoFormatacaoTexto> = {
  parentesco: "textoCurto",
  observacoes: "textoCurto"
};

export const mapaCamposTextoUnidadeAssistencial: Record<string, TipoFormatacaoTexto> = {
...
export const mapaDiretoriaUnidade: Record<string, TipoFormatacaoTexto> = {
  nome_completo: "nomePessoa",
  funcao: "instituicao"
};
...
export const mapaCamposTextoVoluntario: Record<string, TipoFormatacaoTexto> = {
  nome_completo: "nomePessoa",
  genero: "textoCurto",
