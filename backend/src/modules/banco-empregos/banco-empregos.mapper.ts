import type { JobCandidatoRow, JobRow } from "./banco-empregos.types.js";
...
export function mapJobRowToResponse(row: JobRow) {
...
export function mapJobCandidatoRowToResponse(row: JobCandidatoRow) {
  return {
    id: String(row.id),
