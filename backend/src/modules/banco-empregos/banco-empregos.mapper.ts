...
function toCount(value?: number | bigint | null) {
  if (typeof value === "bigint") return Number(value);
  if (typeof value === "number") return value;
  return 0;
}

export function mapBancoEmpregosCandidato(row: BancoEmpregosCandidatoRow) {
  return {
    id: row.id.toString(),
...
export function mapBancoEmpregosVaga(row: BancoEmpregosVagaRow) {
  return {
    id: row.id.toString(),
    titulo: row.titulo,
...
export function mapBancoEmpregosAvaliacao(row?: BancoEmpregosAvaliacaoRow | null) {
  if (!row) return null;
  return {
    id: row.id.toString(),
...
export function mapBancoEmpregosProcesso(
  row: BancoEmpregosProcessoRow,
  avaliacao?: BancoEmpregosAvaliacaoRow | null
) {
  return {
    id: row.id.toString(),
...
export function mapBancoEmpregosDocumento(row: BancoEmpregosDocumentoRow) {
  return {
    id: row.id.toString(),
    candidatoId: row.candidato_id.toString(),
...
export function mapBancoEmpregosHistorico(row: BancoEmpregosHistoricoRow) {
  return {
    id: row.id.toString(),
