import { z } from "zod";
import type {
  BancoEmpregosCategoriaDocumento,
  BancoEmpregosEtapaProcesso,
  BancoEmpregosSituacaoCandidato,
  BancoEmpregosSituacaoVaga,
  BancoEmpregosStatusProcesso
...
const situacaoCandidatoValues = [
  ...
  "BANCO_TALENTOS",
  "INATIVO"
] as const satisfies readonly BancoEmpregosSituacaoCandidato[];
...
const situacaoVagaValues = [
  ...
  "PREENCHIDA",
  "CANCELADA"
] as const satisfies readonly BancoEmpregosSituacaoVaga[];
...
const etapaProcessoValues = [
  ...
  "CONTRATADOS",
  "BANCO_TALENTOS"
] as const satisfies readonly BancoEmpregosEtapaProcesso[];
...
const statusProcessoValues = [
  ...
  "CONTRATADO",
  "BANCO_TALENTOS"
] as const satisfies readonly BancoEmpregosStatusProcesso[];

const categoriaDocumentoValues = [
  "CURRICULO",
  "CERTIFICADO",
  "DOCUMENTO_COMPLEMENTAR"
] as const satisfies readonly BancoEmpregosCategoriaDocumento[];
