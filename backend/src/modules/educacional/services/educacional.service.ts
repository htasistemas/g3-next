...
import { agendaSchema, alunoSchema, anoLetivoSchema, avaliacaoSchema, autorizacaoSchema, boletimSchema, buscaBeneficiarioSchema, calendarioSchema, desenvolvimentoInfantilSchema, diarioSchema, disciplinaSchema, documentoSchema, enturmacaoSchema, etapaSchema, frequenciaSchema, gradeCurricularSchema, historicoSchema, horarioSchema, listaEsperaSchema, matriculaSchema, notaSchema, ocorrenciaSchema, painelEducacionalFiltrosSchema, planejamentoSchema, planoAulaSchema, recuperacaoSchema, resultadoFinalSchema, rotinaInfantilSchema, serieSchema, transferenciaSchema, turmaSchema } from "../educacional.schema.js";
