...
export function mapResumoCandidato(row: any) {
  return {
...
export function mapCandidatoDetalhe(row: any) {
  return {
    id: Number(row.id),
    nomeCompleto: row.nome_completo,
    cpf: row.cpf ?? undefined,
...
export function mapProcesso(row: any) {
  return {
    id: Number(row.id),
    candidatoId: Number(row.candidato_id),
    status: row.status,
...
export function mapEntrevista(row: any) {
  return {
    id: Number(row.id),
...
export function mapFicha(row: any) {
  if (!row) return null;
  return {
    id: Number(row.id),
    processoId: Number(row.processo_id),
...
export function mapDocumento(row: any) {
  return {
    id: Number(row.id),
    processoId: Number(row.processo_id),
...
export function mapArquivo(row: any) {
  return {
    id: Number(row.id),
    processoId: Number(row.processo_id),
...
export function mapTermo(row: any) {
  return {
    id: Number(row.id),
    processoId: Number(row.processo_id),
    tipo: row.tipo,
...
export function mapPpd(row: any) {
  if (!row) return null;
  return {
    id: Number(row.id),
    processoId: Number(row.processo_id),
...
export function mapCartaBanco(row: any) {
  if (!row) return null;
  return {
    id: Number(row.id),
    processoId: Number(row.processo_id),
...
export function mapAuditoria(row: any) {
  return {
