...
export class ArquivosService {
  async listar(rawQuery: Record<string, unknown>) {
  ...
  async upload(request: Request & { authUser?: { id: string }; file?: Express.Multer.File }) {
    if (!request.file) {
