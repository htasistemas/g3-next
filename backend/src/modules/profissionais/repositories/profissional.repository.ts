...
export class ProfissionalRepository {
  async listar(filters: ProfissionalFilters) {
    const where: Prisma.CadastroProfissionalWhereInput = {};
    const andFilters: Prisma.CadastroProfissionalWhereInput[] = [];
  ...
  async criar(input: ProfissionalInput) {
  ...
  async atualizar(id: bigint, input: ProfissionalInput) {
    return prisma.$transaction(async (tx) => {
