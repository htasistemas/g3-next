...
let workerPromise: Promise<Awaited<ReturnType<typeof Tesseract.createWorker>>> | undefined;
...
export class BeneficiarioOcrService {
  async lerCpf(file?: Express.Multer.File) {
    if (!file) throw new AppError("Selecione uma imagem do CPF.", 400);
