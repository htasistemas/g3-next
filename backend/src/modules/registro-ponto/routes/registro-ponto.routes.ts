...
registroPontoRoutes.patch(
  ...
  asyncHandler(controller.ajustarRegistro.bind(controller))
);
...
registroPontoRoutes.post(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesLeitura),
  asyncHandler(controller.adicionarOcorrencia.bind(controller))
);
...
registroPontoRoutes.get(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesLeitura),
  asyncHandler(controller.buscarHistorico.bind(controller))
);
