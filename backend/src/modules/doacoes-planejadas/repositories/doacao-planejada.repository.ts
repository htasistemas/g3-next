...
export class DoacaoPlanejadaRepository {
  async listar(filters: DoacaoPlanejadaFilters, tenantId: string) {
    await ensureDoacaoPlanejadaEstrutura();
    const where: Prisma.Sql[] = [tenantSql("dp", tenantId)];
  ...
  async criar(input: DoacaoPlanejadaInput, tenantId: string) {
    await ensureDoacaoPlanejadaEstrutura();
  ...
  async atualizar(id: bigint, input: DoacaoPlanejadaInput, tenantId: string) {
    await ensureDoacaoPlanejadaEstrutura();
