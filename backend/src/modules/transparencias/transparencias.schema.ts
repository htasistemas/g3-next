...
export const transparenciaInputSchema = z.object({
  ...
  for (const [field, label] of [["totalRecebido", "total recebido"], ["totalAplicado", "total aplicado"], ["saldoDisponivel", "saldo disponível"], ["prestadoMes", "valor prestado no mês"]] as const) {
