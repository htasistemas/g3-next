...
test("deve mascarar cpf, cnpj, email e telefone no historico da IA", () => {
  const texto =
    "CPF 529.982.247-25, CNPJ 11.222.333/0001-81, email maria.silva@exemplo.com.br e telefone (34) 99999-1234.";

  const sanitizado = sanitizeAiHistoryText(texto);

  assert.equal(
    sanitizado,
    "CPF ***.982.247-**, CNPJ **.222.333/0001-**, email ma*********@exemplo.com.br e telefone (34) *****-1234."
  );
});
