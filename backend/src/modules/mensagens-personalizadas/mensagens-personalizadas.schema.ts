import { z } from "zod";
import {
  mensagemCanalEnvioValues,
  mensagemCanalPermitidoValues,
  mensagemDestinatarioValues,
  mensagemHistoricoStatusValues,
  mensagemStatusValues,
  mensagemTaxonomiaTipoValues,
  mensagemTipoEnvioValues
