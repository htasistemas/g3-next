export type AlmoxarifadoKitComponenteEstoque = {
  quantidade_item: number;
  estoque_componente: number;
};

export function calcularEstoqueMontavelKit(
  componentes: AlmoxarifadoKitComponenteEstoque[]
) {
...
export function calcularEstoqueDisponivelKit(
...
export function planejarConsumoSaidaKit(
  estoqueFisico: number,
