...
contabilidadeRoutes.get(
  ...
  asyncHandler(controller.listarContasBancarias.bind(controller))
);
...
contabilidadeRoutes.post(
  ...
  asyncHandler(controller.criarContaBancaria.bind(controller))
);
...
contabilidadeRoutes.put(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.atualizarContaBancaria.bind(controller))
);
...
contabilidadeRoutes.delete(
  ...
  asyncHandler(controller.removerContaBancaria.bind(controller))
);
...
contabilidadeRoutes.get(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesLeitura),
  asyncHandler(controller.listarLancamentos.bind(controller))
);
...
contabilidadeRoutes.post(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.criarLancamento.bind(controller))
);
...
contabilidadeRoutes.put(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.atualizarLancamento.bind(controller))
);
...
contabilidadeRoutes.patch(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.atualizarSituacaoLancamento.bind(controller))
);
...
contabilidadeRoutes.delete(
  ...
  ensureAuthenticated,
  ensurePermissions(permissaoExclusao),
  asyncHandler(controller.removerLancamento.bind(controller))
);
...
contabilidadeRoutes.post(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.criarMovimentacao.bind(controller))
);
...
contabilidadeRoutes.put(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.atualizarMovimentacao.bind(controller))
);
...
contabilidadeRoutes.get(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesLeitura),
  asyncHandler(controller.listarEmendas.bind(controller))
);
...
contabilidadeRoutes.post(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.criarEmenda.bind(controller))
);
...
contabilidadeRoutes.patch(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.atualizarStatusEmenda.bind(controller))
);
