...
oficiosRoutes.post(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.salvarPdfAssinado.bind(controller))
);
oficiosRoutes.get(
  "/:id/pdf-assinado",
  ensureAuthenticated,
  ensurePermissions(permissoesLeitura),
  asyncHandler(controller.obterPdfAssinado.bind(controller))
);
oficiosRoutes.delete(
  "/:id/pdf-assinado",
  ensureAuthenticated,
  ensurePermissions(permissaoExclusao),
  asyncHandler(controller.removerPdfAssinado.bind(controller))
);
...
oficiosRoutes.get(
  ...
  ensureAuthenticated,
  ensurePermissions(permissoesLeitura),
  asyncHandler(controller.listarImagens.bind(controller))
);
oficiosRoutes.post(
  "/:id/imagens",
  ensureAuthenticated,
  ensurePermissions(permissoesEscrita),
  asyncHandler(controller.adicionarImagem.bind(controller))
);
oficiosRoutes.delete(
  "/:id/imagens/:imagemId",
  ensureAuthenticated,
