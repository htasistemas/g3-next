...
export const autorizacaoCompraCotacaoInputSchema = z.object({
  ...
  situacaoCadastral: optionalTrimmedString.nullable().optional(),
  inicioAtividade: optionalIsoDate.nullable().optional(),
  enderecoCartaoCnpj: optionalTrimmedString.nullable().optional(),
