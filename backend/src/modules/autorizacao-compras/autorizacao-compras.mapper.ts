...
export function mapAutorizacaoCompraToResponse(row: AutorizacaoCompraRow) {
  return {
    id: Number(row.id),
    titulo: row.titulo,
    tipo: row.tipo,
...
export function mapAutorizacaoCompraCotacaoToResponse(row: AutorizacaoCompraCotacaoRow) {
  return {
    id: Number(row.id),
