...
export function mapCaptacaoDoador(row: SqlRow) {
  return {
...
export function mapCaptacaoCampanha(row: SqlRow) {
...
export function mapCaptacaoRecorrencia(row: SqlRow) {
  return {
    id: toStringId(row.id as bigint | number),
    uuid: toOptionalString(row.uuid) ?? "",
...
export function mapCaptacaoDoacao(row: SqlRow) {
  return {
    id: toStringId(row.id as bigint | number),
    uuid: toOptionalString(row.uuid) ?? "",
...
export function mapCaptacaoComprovante(row: SqlRow) {
  return {
    id: toStringId(row.id as bigint | number),
    uuid: toOptionalString(row.uuid) ?? "",
...
export function mapCaptacaoConfiguracoes(row?: SqlRow | null) {
  return {
...
export function mapCaptacaoLog(row: SqlRow) {
  return {
    id: toStringId(row.id as bigint | number),
