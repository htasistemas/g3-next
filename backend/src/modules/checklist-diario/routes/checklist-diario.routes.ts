...
checklistDiarioRoutes.get(
  "/indicadores",
  ensurePermissions(["ADMINISTRADOR", "SETOR_ADMINISTRATIVO_CHECKLIST_DIARIO_VISUALIZAR_INDICADORES", "SETOR_ADMINISTRATIVO_CHECKLIST_DIARIO_VISUALIZAR_TODOS"]),
  asyncHandler(controller.obterIndicadores.bind(controller))
);
