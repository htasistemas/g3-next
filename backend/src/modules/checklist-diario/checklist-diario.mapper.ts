...
export function mapChecklistModeloItem(item: ChecklistModeloItemRow) {
  return {
...
export function mapChecklistModelo(modelo: ChecklistModeloRow, itens: ChecklistModeloItemRow[]) {
  return {
...
export function mapChecklistExecucao(row: ChecklistExecucaoRow) {
  return {
...
export function mapChecklistHistorico(row: ChecklistHistoricoRow) {
  return {
    id: toStringId(row.id),
...
export function mapChecklistConfiguracao(row: ChecklistConfiguracaoRow) {
  return {
    id: toStringId(row.id),
...
export function mapChecklistIndicadores(row?: ChecklistIndicadoresRow) {
